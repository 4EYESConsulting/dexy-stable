...
\begin{tabular}{|l|l|l|}
\hline
\textbf{Action} & \textbf{Range}                                  & \textbf{Entity} \\ \hline
FreeMint        & $1 - \epsilon_{\textrm{FREE}} \le r \le 1 + \epsilon_{\textrm{FREE}}$ & User   \\ \hline
ArbMint         & $r > 1 + \epsilon_{\textrm{FREE}}$                         & User   \\ \hline
InjectBasecoins & $r < 1 - \epsilon_{\textrm{FREE}}$                         & Bank   \\ \hline
ExtractDexy     & $r \le 1 - \epsilon_{\textrm{ED}} < 1 - \epsilon_{\textrm{FREE}}$     & Bank   \\ \hline
ReleaseDexy     & $1 + \epsilon_{\textrm{RD}} < r <  1 + \epsilon_{\textrm{FREE}}$      & Bank  \\ \hline
\end{tabular}
\end{table}
...
\begin{itemize}
  \item $s_{\textrm{BANK}} = \left(R, S_{D} \right)$
\end{itemize}
